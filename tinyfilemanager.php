...
<?php
    ...
    function lng($txt)
    {
        ...
        // 默认内置回退语言：简体中文
        $tr['zh-CN']['AppName']        = APP_BRAND;
        $tr['zh-CN']['AppTitle']       = APP_BRAND;
        $tr['zh-CN']['Login']          = '登录';
        $tr['zh-CN']['Username']       = '账号';
        $tr['zh-CN']['Password']       = '密码';
        $tr['zh-CN']['Logout']         = '退出';
        $tr['zh-CN']['Move']           = '移动';
        $tr['zh-CN']['Copy']           = '复制';
        $tr['zh-CN']['Save']           = '保存';
        $tr['zh-CN']['SelectAll']      = '全选';
        $tr['zh-CN']['UnSelectAll']    = '取消全选';
        $tr['zh-CN']['File']           = '文件';
        $tr['zh-CN']['Back']           = '取消';
        $tr['zh-CN']['Size']           = '大小';
        $tr['zh-CN']['Perms']          = '权限';
        $tr['zh-CN']['Modified']       = '修改时间';
        $tr['zh-CN']['Owner']          = '拥有者';
        $tr['zh-CN']['Search']         = '搜索';
        $tr['zh-CN']['NewItem']        = '创建新文件/文件夹';
        $tr['zh-CN']['Folder']         = '文件夹';
        $tr['zh-CN']['Delete']         = '删除';
        $tr['zh-CN']['Rename']         = '重命名';
        $tr['zh-CN']['CopyTo']         = '复制到';
        $tr['zh-CN']['DirectLink']     = '直链';
        $tr['zh-CN']['UploadingFiles'] = '上传';
        $tr['zh-CN']['ChangePermissions']  = '修改权限';
        $tr['zh-CN']['Copying']        = '复制中';
        $tr['zh-CN']['CreateNewItem']  = '创建新文件';
        $tr['zh-CN']['Name']           = '文件名';
        $tr['zh-CN']['AdvancedEditor'] = '高级编辑器';
        $tr['zh-CN']['Actions']        = '执行操作';
        $tr['zh-CN']['Folder is empty'] = '文件夹为空';
        $tr['zh-CN']['Upload']         = '上传';
        $tr['zh-CN']['Cancel']         = '取消';
        $tr['zh-CN']['InvertSelection'] = '反向选择';
        $tr['zh-CN']['DestinationFolder']  = '目标文件夹';
        $tr['zh-CN']['ItemType']       = '文件类型';
        $tr['zh-CN']['ItemName']       = '创建名称';
        $tr['zh-CN']['CreateNow']      = '创建';
        $tr['zh-CN']['Download']       = '下载';
        $tr['zh-CN']['Open']           = '打开';
        $tr['zh-CN']['UnZip']          = '解压缩';
        $tr['zh-CN']['UnZipToFolder']  = '解压至目标文件夹';
        $tr['zh-CN']['Edit']           = '编辑';
        $tr['zh-CN']['NormalEditor']   = '编辑器';
        $tr['zh-CN']['BackUp']         = '备份';
        $tr['zh-CN']['SourceFolder']   = '源文件夹';
        $tr['zh-CN']['Files']          = '文件';
        $tr['zh-CN']['Change']         = '修改';
        $tr['zh-CN']['Settings']       = '设置';
        $tr['zh-CN']['Language']       = '语言';
        $tr['zh-CN']['ErrorReporting'] = '上传错误报告';
        $tr['zh-CN']['ShowHiddenFiles'] = '显示隐藏文件';
        $tr['zh-CN']['Help']           = '帮助';
        $tr['zh-CN']['Created']        = '创建';
        $tr['zh-CN']['Help Documents'] = '帮助文档';
        $tr['zh-CN']['Report Issue']   = '报告问题';
        $tr['zh-CN']['Generate']       = '生成';
        $tr['zh-CN']['FullSize']       = '所有文件大小';
        $tr['zh-CN']['HideColumns']    = '隐藏权限&拥有者';
        $tr['zh-CN']['You are logged in'] = '您已登录';
        $tr['zh-CN']['Nothing selected']  = '没有任何选定项';
        $tr['zh-CN']['Paths must be not equal']    = '路径不能相同';
        $tr['zh-CN']['Renamed from']       = '生成';
        $tr['zh-CN']['Archive not unpacked'] = '解压失败';
        $tr['zh-CN']['Deleted']            = '删除';
        $tr['zh-CN']['Archive not created'] = '压缩包创建失败';
        $tr['zh-CN']['Copied from']        = '复制';
        $tr['zh-CN']['Permissions changed'] = '权限已修改';
        $tr['zh-CN']['to']                 = '到';
        $tr['zh-CN']['Saved Successfully'] = '保存成功';
        $tr['zh-CN']['not found!']         = '没有找到！';
        $tr['zh-CN']['File Saved Successfully']    = '文件保存成功';
        $tr['zh-CN']['Archive']            = '压缩包';
        $tr['zh-CN']['Permissions not changed']    = '权限修改失败';
        $tr['zh-CN']['Select folder']      = '选择文件夹';
        $tr['zh-CN']['Source path not defined']    = '没有定义源路径';
        $tr['zh-CN']['already exists']     = '已存在';
        $tr['zh-CN']['Error while moving from']    = '移动失败';
        $tr['zh-CN']['Create archive?']    = '创建压缩包？';
        $tr['zh-CN']['Invalid file or folder name']    = '无效的文件或文件夹名';
        $tr['zh-CN']['Archive unpacked']   = '压缩包已经解压';
        $tr['zh-CN']['File extension is not allowed']  = '该文件格式不支持';
        $tr['zh-CN']['Root path']          = '根路径';
        $tr['zh-CN']['Error while renaming from']  = '重命名失败';
        $tr['zh-CN']['File not found']     = '找不到文件';
        $tr['zh-CN']['Error while deleting items'] = '删除失败';
        $tr['zh-CN']['Moved from']         = '移动';
        $tr['zh-CN']['Generate new password hash'] = '生成新的hash密码';
        $tr['zh-CN']['Login failed. Invalid username or password'] = '登录失败。用户名或密码无效';
        $tr['zh-CN']['password_hash not supported, Upgrade PHP version'] = '不支持password_hash,请升级PHP版本';
        $tr['zh-CN']['Advanced Search']    = '高级搜索';
        $tr['zh-CN']['Error while copying from']    = '复制失败';
        $tr['zh-CN']['Invalid characters in file name']                = '无效的文件名';
        $tr['zh-CN']['FILE EXTENSION IS NOT SUPPORTED']                = '该文件格式不支持';
        $tr['zh-CN']['Selected files and folder deleted']              = '已删除选择的文件和目录';
        $tr['zh-CN']['Error while fetching archive info']              = '获取压缩包信息失败';
        $tr['zh-CN']['Delete selected files and folders?']             = '确认删除已选择的文件和目录？';
        $tr['zh-CN']['Search file in folder and subfolders...']        = '在文件夹和子目录中搜索文件...';
        $tr['zh-CN']['Access denied. IP restriction applicable']       = '访问被拒绝。适用的IP限制';
        $tr['zh-CN']['Invalid characters in file or folder name']      = '无效的文件或文件夹名称';
        $tr['zh-CN']['Operations with archives are not available']     = '压缩包操作不可用';
        $tr['zh-CN']['File or folder with this path already exists']   = '该路径的文件或文件夹已经存在';
        $tr['zh-CN']['Are you sure want to rename?']                   = '您确认要重命名吗？';
        $tr['zh-CN']['Are you sure want to']                           = '您确定要';
        $tr['zh-CN']['Date Modified']                                  = '修改时间';
        $tr['zh-CN']['File size']                                      = '文件大小';
        $tr['zh-CN']['MIME-type']                                      = '文件类型';
        $tr['zh-CN']['a files']                                        = '文件';
        ...
        else if (isset($tr['zh-CN'][$txt])) return fm_enc($tr['zh-CN'][$txt]);
        else return "$txt";
    }
